// ローディング表示
function showLoading(form: HTMLFormElement): void {
...
// Toast表示関数
declare const bootstrap: any; // bootstrapの型定義がない場合を想定
...
function showToast(message: string, type: 'success' | 'error' = 'success'): void {
    ...
    const toastEl = document.getElementById(toastId) as HTMLElement | null;
    if (toastEl) {
